...
'LIVER & BILE', 'ANTI-HAEMORRHOIDAL', 'HAIR CARE'
  ...
  function validateCSVRow(raw, rowIndex) {
   ...
   // ── E06 — category: required, normalize & and 'and', enum check ──
    ...
    const STRENGTH_UNIT_RE = /\d(BILLION CFU|MCG\/ACTUATION|G\/100ML|MG\/5ML|CCID50|TCID50|MG\/M²|MG\/M2|MG\/KG|KG\/NG|MG\/ML|KG\/L|MG\/G|MCG|MIU|MEQ|CFU|IU|ML|LF|NG|KG|MG|G|U|%)/i;
